 ...
 angular.module('dataApp').service('dataService', ['$q', '$http', function ($q, $http) {
     /**
      * DataService
      * promise base for data service(optional)
      * @constructor
      */
     // Promise-based API
     return {
         ...
         loadInfo: function () {
             ...
             //return $http.get('http://9tmys.ngrok.natapp.cn/backend/data/info');
             // return $q.when(users);
         }
         , getAll: function () {
